...
var CHAR_COLON = ':';
>>>>>>> c8f69eb7d077a5f7435e254a09c0fa919088bc13
var CHAR_REQUIRED = '!';
var CHAR_UNION = '|';
...
=======
        var subtree = buildTree(innerTokens);
        child = {
          type: group.type,
...
>>>>>>> c8f69eb7d077a5f7435e254a09c0fa919088bc13
  ...
  var splitToNamesAndValues = function splitToNamesAndValues(children) {
    var list = [];

    var name = void 0;
    var prevColonIndex = void 0;

    for (var i = 0; i < children.length; i++) {
      var child = children[i];
      if (child.token === CHAR_COLON) {
        if (prevColonIndex) {
          if (!name) {
            throw new Error('Expected name.');
          }
          if (i - 1 - (prevColonIndex + 1) <= 0) {
            throw new Error('Expected type.');
          }
          list.push({
            name: name,
            values: children.slice(prevColonIndex + 1, i - 1)
          });
          name = null;
        }
        name = children[i - 1];
  ...
  var parseShapeNode = function parseShapeNode(_ref) {
